 ...
 *
 * GENERATED — do not hand-edit. Regenerate from the SVGs if the design changes.
...
object StoryMapLayout {
    ...
    private val CH8 = ChapterMap(
        ...
        nodes = listOf(
            ...
            MapNode("D1", NodeKind.TEXT, "dream_match", listOf("没有你的世界"), cx = 540f, cy = 930f, r = 12f, side = NodeSide.CENTER),
            MapNode("D1", NodeKind.TEXT, "dream_celebrate", listOf("没有你的世界"), cx = 900f, cy = 930f, r = 12f, side = NodeSide.CENTER),
            MapNode("D2", NodeKind.IMAGE, "dream_return", listOf("他的名字"), x = 40f, y = 1250f, w = 280f, h = 140f),
            MapNode("D3", NodeKind.TEXT, "dream_home", listOf("看台上的庆祝"), cx = 180f, cy = 1710f, r = 12f, side = NodeSide.CENTER),
            MapNode("D3", NodeKind.TEXT, "dream_final", listOf("看台上的庆祝"), cx = 540f, cy = 1710f, r = 12f, side = NodeSide.CENTER),
            MapNode("D3", NodeKind.TEXT, "stay_match", listOf("看台上的庆祝"), cx = 900f, cy = 1710f, r = 12f, side = NodeSide.CENTER),
            MapNode("D4", NodeKind.TEXT, "stay_intro", listOf("久别重逢"), cx = 180f, cy = 2100f, r = 12f, side = NodeSide.CENTER),
            MapNode("D4", NodeKind.TEXT, "stay_cozy", listOf("久别重逢"), cx = 540f, cy = 2100f, r = 12f, side = NodeSide.CENTER),
            MapNode("D5", NodeKind.TEXT, "stay_daily", listOf("花园别墅", "秘密基地"), cx = 180f, cy = 2490f, r = 12f, side = NodeSide.CENTER),
            MapNode("D5", NodeKind.TEXT, "stay_final", listOf("花园别墅", "秘密基地"), cx = 900f, cy = 2490f, r = 12f, side = NodeSide.CENTER),
            MapNode("D6", NodeKind.IMAGE, "bad_elegant", listOf("世界第一，与你"), x = 40f, y = 2810f, w = 280f, h = 140f),
            MapNode("S2", NodeKind.TEXT, "bad_plan", listOf("他常回来"), cx = 540f, cy = 1320f, r = 12f, side = NodeSide.CENTER),
            MapNode("S5", NodeKind.IMAGE, "bad_match", listOf("关掉的比赛录像"), x = 400f, y = 2420f, w = 280f, h = 140f),
            MapNode("B2", NodeKind.IMAGE, "bad_afterglow", listOf("他的名字"), x = 760f, y = 1250f, w = 280f, h = 140f),
            MapNode("B4", NodeKind.IMAGE, "bad_cold", listOf("全世界都看见你"), x = 760f, y = 2030f, w = 280f, h = 140f),
