# Nagi's Heart · SCRIPT V15 BG Mapping · CoCo Draft v1.1

> Owner: CoCo Design  
> Source script: `design/Nagis_Heart_SCRIPT_V15_Calibrated.md`  
> BG source: `assets/bg/`  
> Date: 2026-07-10  
> Review status: v1.0 approved; v1.1 adds PM review adjustments.
...
|---|---|---|---|
| p1 | 作战室·初遇 | 需要蓝色监狱作战室 / 多屏监控 / 投资观察席，现有图只有球员或生活场景 | 冷蓝监控室、屏幕墙、观察席 |
| p2 | 投资的私心 | 接待室、签字页、投资文件缺图 | JFA 接待室、桌面文件、冷光商务室 |
| c1a | 会议室初见 | 需要蓝色监狱内部会议室和初见氛围，现有 Nagi 肖像不等于场景 | 简洁会议室、Nagi 入门、冷白灯 |
...
|---|---|---|---|---|
| p1 | 作战室·初遇 | reflection | 冷蓝监控室、屏幕墙、观察席 | 开篇世界观第一视觉锚点。 |
| c1a | 会议室初见 | romance | 蓝色监狱内部会议室、Nagi 入门、冷白灯 | 第一次面对面，不能只用普通肖像图。 |
...
| 1 | p1 | 作战室·初遇 | 空缺 |  | dark | 需要多屏和观察席安全区 | 可用 `teamV.jpg` 做屏幕 cut-in，但不建议当主 bg。 |
| 1 | p2 | 投资的私心 | 空缺 |  | light / auto | 需要桌面文件区避开底部文本 | 投资签字页是关键叙事物件，现有图不匹配。 |
| 1 | c1a | 会议室初见 | 空缺 |  | auto | 需要人物上半身和会议桌空间 | 现有肖像图会把初见变成普通立绘，不够场景化。 |
| 1 | c1b | 不麻烦的人 | 空缺 |  | dark | LINE 专用界面优先 | 建议用 LINE Mode 背景，不配普通剧情 bg。 |
| 1 | u20j | U-20日本代表战·被日本看见 | 临时代用 | `assets/bg/goal.jpg` | dark | 强光在上方，底部加深保证文字 | 适合比赛当天；前夜聊天段仍用 LINE Mode。 |
...
| 3 | c6a | 聚少离多·从高光到淘汰 | 临时代用 | `assets/bg/goal.jpg` | dark | 强光上方，剧情文字放下半区 | 适合 BLTV / 比赛高光，不完全覆盖低谷段。 |
...
| 4 | wc_keygoal | 生死局·世界看见他 | 已配 | `assets/bg/goal.jpg` | dark | 强光顶部，底部加深 | 比赛高光节点匹配。 |
| 4 | wc_offer | 豪门来信 | 临时代用 | `assets/bg/back.jpg` | light / auto | 保留行李箱和商务空间 | 可表达豪门邀请 / 出发感，但采访区和酒店房间不完整。 |
| 5 | w_home | 归来·沙发上的拥抱 | 已配 | `assets/bg/home_full.jpg` | dark / auto | 横图需裁沙发主体，底部文本 | 匹配回家、沙发、亲密日常。 |
| 5 | mt3 | 同居·这里太舒服了 | 已配 | `assets/bg/livingroom.jpg` | light / auto | 横图裁客厅，留底部对话区 | 适合同居生活搭建。 |
...
| 5 | w_noodle | 深夜·酸奶与泡面哲学 | 临时代用 | `assets/bg/wakeup.jpg` | dark | 人物上中，底部叙事层 | 有床边夜间气质，但缺酸奶 / 泡面道具。 |
...
| 5 | e_morning | 早安赖床 | 已配 | `assets/bg/morning.jpg` | light | 脸部在上半，文字置底 | 高匹配。 |
...
| 5 | e_festival | 夏日祭·浴衣与烟火 | 已配 | `assets/bg/summerfestival.jpg` | dark | 烟火上方，人物 / 文本安全区分离 | 高匹配。 |
| 5 | transfer_contract | 夏窗·签约桌上的好麻烦 | 空缺 |  | light / auto | 需要合同桌面安全区 | 现有商务图不够合同谈判。 |
| 6 | club_arrival | 曼城·新的房间 | 已配 | `assets/bg/back.jpg` | light | 人物和行李箱保留，底部文字 | 高匹配新城市入住。 |
| 6 | club_alone | 一个人的曼城 | 临时代用 | `assets/bg/apartment.jpg` | light / auto | 人物居中，城市窗景保留 | 高层公寓感可用，缺异国孤独感。 |
...
| 7M | e_scarf | 送围巾 | 已配 | `assets/bg/scarf.jpg` | light | 围巾和人物上半安全 | 高匹配。 |
...
| 8 | p8_route | 假期结束·春季名单 | 临时代用 | `assets/bg/bedroom.jpg` | dark | 夜景和床区保留，底部文本 | 这里不是纯亲密节点，而是东京假期结束、人生重新分岔；后续建议补机场 / 夜景 / 离别氛围素材。 |
| Dream | dream_exist | 没有你的世界 | 临时代用 | `assets/bg/bedroom.jpg` | dark | 需要更强酒店夜雨感 | 可暂用夜间卧室，但欧洲酒店 / 雨夜不够明确。 |
| Dream | dream_match | 他的名字 | 已配 | `assets/bg/worldstage.jpg` | dark | 眼睛和冷蓝光在上中，底部结算前文本 | 成名战气质强。 |
| Dream | dream_celebrate | 看台上的庆祝 | 临时代用 | `assets/bg/goal.jpg` | dark | 顶部强光，底部加深 | 只有球场光，不够“看台庆祝”。 |
...
| Stay | stay_match | 还不是今天 | 临时代用 | `assets/bg/goal.jpg` | dark | 同梦线比赛图，但降饱和 / 降高光 | 可用同球场图表现“没成为他的夜晚”。 |
| Stay | stay_intro | 他常回来 | 已配 | `assets/bg/home_full.jpg` | dark / auto | 沙发和客厅保留 | 普通情侣节奏匹配。 |
...
| Bad | bad_last | 我不是不想赢 | 空缺 |  | dark | 需要雨后训练基地外 | `fallingdown.jpg` 可做情绪 cut-in，但不是场景。 |
