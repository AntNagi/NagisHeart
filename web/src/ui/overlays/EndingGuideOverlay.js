...
export class EndingGuideOverlay {
  ...
  _localizeRouteText(value) {
    return String(value)
      ...
      .replace(/club_arrival/g, '到达俱乐部')
      .replace(/club_media/g, '俱乐部媒体选择')
      .replace(/e_autumn/g, '秋季事件')
      .replace(/e_drive/g, '驾车事件')
      .replace(/route_mj_hidden/g, '关系路线判定')
      .replace(/M_score/g, 'M 线累计值')
      .replace(/J_score/g, 'J 线累计值')
      .replace(/line =/g, '关系路线 =')
