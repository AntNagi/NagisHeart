...
| # | 权威 | 文件 | MD5 | 最近修订 |
|---|---|---|---|---|
| 1 | 产品 PRD | `product/NagisHeart_PRD_v2_0.md` | `F717B046839228E4329CB59DE9E1C91F` | 2026-07-20 |
| 2 | 交互设计 | `interaction/NagisHeart_Interaction_Design_v1_0.md` | `BC12452B98A06144A6A5ABE0B02245CA` | 2026-07-20（§31 实机反馈补丁） |
| 3 | 剧本母版 | `script/Nagis_Heart_SCRIPT_V15_Calibrated.md` | `DE39C5546E8ECBCCB60BFAF1C4AEA3EA` | V15 校准版 |
| 4 | 剧情逻辑 coreDesign | `story_logic/NagisHeart_Design_V3_1_Latest_UtopiaAdded.md` | `00BFDA6DE4E397DF4AC9D8FF8082A71D` | V3.1（2026-07-21 Ant 确认为正主） |
| 5 | UI 设计稿 | `ui/NagisHeart_UI_Authority_XoXo_v1_0.html` | `5B55D1CE9B0FB1ACE1EF82BF10584EFE` | 2026-07-20（ending-card CSS：渐变遮罩/text-shadow/玻璃卡片） |
| 6 | UI 数值规范 MinSpec | `ui/XoXo_UI_Final_MinSpec_20260712.md` | `666E9A8C30312F537BE0C97993986D13` | 2026-07-21（§1 暗层/§5 主页/§7 HUD/§19 选项/§20 LINE/§21 核对表/§22 存档设置行项） |
| 7 | BG Mapping | `visual_mapping/NagisHeart_SCRIPT_V15_BG_Mapping_CoCo_XoXo_v1_2.md` | `AFD5F7D921D6C9AF37F2F33FEBBBC3C7` | v1.2（2026-07-20 加 §7 画廊结局 BG 规则） |
